                ...
                <div className='ur-container'>
                    <div className='ur-heading-cont'>
						...
						<form className='ur-main-cont' onSubmit={handleSubmit}>
							...
							<input className='ur-input-field' type="date" id="date" value={date} min={new Date().toISOString().split('T')[0]} onChange={(e) => setDate(e.target.value)} />
							<br/>
							<label htmlFor="time">Time</label>
							<input className='ur-input-field' type="time" id="time" value={time} min="09:00" max="22:00" onChange={(e) => setTime(e.target.value)} />
							<br/>
							<label htmlFor="location">Location</label>
							<select className='ur-input-field' id="location" value={location} onChange={(e) => setLocation(e.target.value)}>
							...
							<input className='ur-input-field'
							type="number"
							id="numTables"
							value={numTables}
							min="1" max="20"
